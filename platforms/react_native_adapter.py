"""React Native platform adapter stub — not yet implemented. Planned for v2.0."""
...
_NOT_IMPLEMENTED = "React Native adapter is not yet implemented. Planned for Mopot v2.0."


class ReactNativeAdapter(MobilePlatformAdapter):
